// This code was initially borrowed from https://www.npmjs.com/package/@types/sigmajs
// It's been updated on an ad-hoc basis to work with Sigma 1.2.1, and edited freely to make the names nicer
// There are very likely to be errors and omissions left over
...
declare module "sigma" {
  ...
  // Passed to the sigma instance which constructs the Graph object
  interface GraphData {
    edges: Edge[];
    nodes: Node[];
  }
  ...
  interface Sigma {
    ...
    addRenderer(settings: RendererSettings): Renderer;
    ...
    // forceAtlas2 layout
    configForceAtlas2(settings: { [key: string]: any }): void;
  ...
  interface SigmaFactory {
    ...
    new(params: InitializationParameters): Sigma;
    canvas: Canvas;
    classes:Classes;
    misc: Miscellaneous;
    parsers: Parsers;
  ...
  declare var sigma: SigmaFactory;
  declare var CustomShapes: CustomShapes;
  declare var ShapeLibrary: CustomShapes;
}
